...
def main(args):
    ...
    for step in range(1001):
        ...
        if step % 10 == 0:
            torch.save(maml.net.state_dict(), "onn_birdcall_lr0.4mlr0.01shot1.pth")
            print('LR = 0.4, MetaLR = 0.01, 1-shot step:', step, '\ttraining acc:', accs)
...
if __name__ == '__main__':
    ...
    argparser.add_argument('--update_lr', type=float, help='task-level inner update learning rate', default=4e-1)
