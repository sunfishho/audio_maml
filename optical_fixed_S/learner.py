    ...
    def __init__(self, config, imgc, imgsz, mb):
        ...
        for i, (name, param) in enumerate(self.config):
            if name == 'conv2d':
                ...
                self.actual_vars.append(conv_layer.U)
                self.actual_vars.append(conv_layer.V)
                ...
                self.actual_vars.append(linear_layer.U)
                self.actual_vars.append(linear_layer.V)
    ...
    def forward(self, x, vars=None, bn_training=True):
        ...
        for name, param in self.config:
            if name == 'conv2d':
                ...
                u, s, v, b = vars[vars_actual_idx], self.vars[vars_idx + 1], vars[vars_actual_idx + 1], vars[vars_actual_idx + 2]
